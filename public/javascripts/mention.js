   ...
   _createClass(Mention, [{
      ...
      */
      ...
      value: function setupHTML() {
         ...
         this.input.parentElement.insertBefore(this.html.wrapper, this.input);
         this.html.wrapper.appendChild(this.input);
      ...
      */
      ...
      value: function onEventOptionClick(optionEle) {
         ...
         var splitInputValue = this.input.innerHTML.split('');
         splitInputValue.splice(this.wordAtCursor.index, this.wordAtCursor.word.length, word);
         this.input.innerHTML = splitInputValue.join('');
         this.input.focus();
      ...
      */
      ...
      value: function cursorPositionChanged() {
         this.cursorPosition = this.input.getAttribute('length');
         this.wordAtCursor = this.readWordAtCursor({ cursorPosition: this.input.getAttribute('length'), value: this.input.innerHTML });
      ...
      */
      ...
      value: function findMatches() {
         var inputValue = this.input.innerHTML.split('').concat([' ']);
         var words = [];
